...
from tkinter import ttk, Canvas, StringVar, Frame, Label
...
# Refresh time for the snake's movement
REFRESH_TIME = 100

# Classes
class Master(Canvas):
    """Create the game canvas, the snake, the obstacle, and keep track of the score."""
    ...
    def redirect(self, event):
        """Take keyboard inputs and move the snake accordingly."""
